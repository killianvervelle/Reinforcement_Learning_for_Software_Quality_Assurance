...
public class PerformanceTester {
	...
	private void executeOoS() {
		...
		net.sourceforge.jFuzzyLogic.test.performance.TestExecutioner executioner = new net.sourceforge.jFuzzyLogic.test.performance.TestExecutioner();
		pause(1000);

		net.sourceforge.jFuzzyLogic.test.performance.PerformanceChart chart = new net.sourceforge.jFuzzyLogic.test.performance.PerformanceChart(stepSize, "Performance Comparison (3 rules)");
		...
		pause(1000);
		net.sourceforge.jFuzzyLogic.test.performance.PerformanceChart chart2 = new net.sourceforge.jFuzzyLogic.test.performance.PerformanceChart(stepSize, "Performance Comparison (30 rules)");
	...
	private void executeTrust() {
		...
		net.sourceforge.jFuzzyLogic.test.performance.TestExecutioner executioner = new TestExecutioner();
		pause(1000);
		...
		net.sourceforge.jFuzzyLogic.test.performance.PerformanceChart chart2 = new PerformanceChart(stepSize, "Performance Comparison (30 rules)");
		chart2.addData(executioner.execute(tsMany, inputVariables, steps, stepSize), "Takagi-Sugeno");
		chart2.addData(executioner.execute(mamMany, inputVariables, steps, stepSize), "Mamdani");
		chart2.addData(executioner.execute(larsenMany, inputVariables, steps, stepSize), "Larsen");
		chart2.addData(executioner.execute(singletonMany, inputVariables, steps, stepSize), "Singleton");
