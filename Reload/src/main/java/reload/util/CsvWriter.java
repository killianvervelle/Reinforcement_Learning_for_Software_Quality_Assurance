...
public class CsvWriter {
    ...
    private final String fullLogFileName;
    private final String logFileName;

    public CsvWriter(DqnProperties dqnProperties, int maxResponseTimeThreshold, Double maxErrorRateThreshold, int episodeExecutionDelay) {
    ...
    public static String createFile(String type) {
        String logFileName = "/home/ubuntu/apache-jmeter/" + java.time.LocalDate.now() + "_" + type + ".csv";
        try {
